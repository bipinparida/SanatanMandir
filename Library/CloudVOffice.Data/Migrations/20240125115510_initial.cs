    ...
    public partial class initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, null, "Applications", "Application", 1L, new DateTime(2024, 1, 25, 17, 25, 10, 223, DateTimeKind.Local).AddTicks(9198), false, "icon-th-large-outline", "/appstatic/images/applications.png", true, null, null, null, "/Application/Applications/InstalledApps" },
                    { 2, null, "Setup", "Setup", 1L, new DateTime(2024, 1, 25, 17, 25, 10, 223, DateTimeKind.Local).AddTicks(9206), false, "icon-cogs", "/appstatic/images/setup.png", true, null, null, null, "/Setup/Setup/Dashboard" },
                    { 3, null, "Company Settings", "Setup", 1L, new DateTime(2024, 1, 25, 17, 25, 10, 223, DateTimeKind.Local).AddTicks(9213), false, "icon-office", null, true, 2, null, null, "" },
                    { 4, null, "Company", "Setup", 1L, new DateTime(2024, 1, 25, 17, 25, 10, 223, DateTimeKind.Local).AddTicks(9216), false, null, null, false, 3, null, null, "/Setup/CompanyDetails/CompanyDetailsView" },
                    { 5, null, "Letter Head", "Setup", 1L, new DateTime(2024, 1, 25, 17, 25, 10, 223, DateTimeKind.Local).AddTicks(9218), false, null, null, false, 3, null, null, "/Setup/LetterHead/LetterHeadView" },
                    { 6, null, "User", "Setup", 1L, new DateTime(2024, 1, 25, 17, 25, 10, 223, DateTimeKind.Local).AddTicks(9221), false, "icon-users", null, true, 2, null, null, "" },
                    { 7, null, "User List", "Setup", 1L, new DateTime(2024, 1, 25, 17, 25, 10, 223, DateTimeKind.Local).AddTicks(9224), false, null, null, false, 6, null, null, "/Setup/User/UserList" }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1L, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 223, DateTimeKind.Local).AddTicks(7886), null, false, "admin@appman.in", null, "Administrator", true, new DateTime(1, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), null, null, "", null, "r9NmU79/NE0x0el2cuI8PeI4GlVCdpOeB875sWPUeJw=", "9583000000", null, null, null, null, 1, 1 });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 1, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(84), false, 1, null, null },
                    { 2L, 2, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(90), false, 1, null, null },
                    { 3L, 3, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(150), false, 1, null, null },
                    { 4L, 4, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(152), false, 1, null, null },
                    { 5L, 5, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(154), false, 1, null, null },
                    { 6L, 6, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(156), false, 1, null, null },
                    { 7L, 7, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(158), false, 1, null, null },
                    { 8L, 8, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(160), false, 1, null, null },
                    { 9L, 9, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(162), false, 1, null, null },
                    { 10L, 10, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(164), false, 1, null, null }
                });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1L, 1, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(979), false, null, null, 1L },
                    { 2L, 2, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(985), false, null, null, 1L },
                    { 3L, 3, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(988), false, null, null, 1L },
                    { 4L, 4, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(990), false, null, null, 1L },
                    { 5L, 5, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(992), false, null, null, 1L },
                    { 6L, 6, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(994), false, null, null, 1L },
                    { 7L, 7, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(996), false, null, null, 1L },
                    { 8L, 8, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(998), false, null, null, 1L },
                    { 9L, 9, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(1000), false, null, null, 1L },
                    { 10L, 10, 1L, new DateTime(2024, 1, 25, 17, 25, 10, 224, DateTimeKind.Local).AddTicks(1002), false, null, null, 1L }
                });

...
namespace SanatanMandir.Controllers
{
	...
	public class SanatanMandirInstallController : Controller
	{
		...
		private readonly string InstationPath = "SanatanMandir";
		public SanatanMandirInstallController(IApplicationInstallationService applicationInstallationService, IRoleService roleService,
